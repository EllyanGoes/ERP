        ...
        <div className="flex items-center gap-2">
          <div className="relative flex-1 max-w-sm">
            ...
            <input
              ...
              className="w-full pl-9 pr-8 py-2 text-sm border border-border rounded-lg bg-card focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
            {search && (
            ...
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-border">
                {items.map((item) => (
                  ...
                  >
                    <td className="px-4 py-3 font-mono text-xs font-semibold text-foreground">{item.codigo}</td>
                    <td className="px-4 py-3 font-medium text-foreground">{item.descricao}</td>

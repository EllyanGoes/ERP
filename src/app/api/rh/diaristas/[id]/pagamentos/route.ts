...
import { pagarItensDiaria, RhPagamentoErro } from "@/lib/rh-pagamentos";

// POST /api/rh/diaristas/[id]/pagamentos — paga as diárias dos diaristas
...
export async function POST(req: NextRequest, { params }: { params: { id: string } }) {
  ...
  try {
    const r = await pagarItensDiaria(params.id, { itemIds, dataPagamento, contaBancariaId });

    ...
    const item = await prisma.$transaction(async (tx) => {
      const newItem = await tx.item.create({
        data: {
          ...
          naturezaPadraoId: body.naturezaPadraoId || null,
          ...
          ...(typeof body.fabril === "boolean" ? { fabril: body.fabril } : {}),
          ...(typeof body.capitaliza === "boolean" ? { capitaliza: body.capitaliza } : {}),
          ...(typeof body.compoeCusto === "boolean" ? { compoeCusto: body.compoeCusto } : {}),

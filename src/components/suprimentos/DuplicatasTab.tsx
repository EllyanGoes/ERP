...
// Aba "Duplicatas" do Documento de Entrada: mostra as parcelas do contas a pagar
// que a nota vai gerar. Antes de concluir → PRÉVIA calculada no cliente; depois de
// concluída → os títulos reais vinculados. Compartilhada entre as telas de
// criação e detalhe do DE.
...
export default function DuplicatasTab({ titulosReais, preview, condicaoNome, fornecedorNome, headerControls }: Props) {
  ...
  return (
    <div className="space-y-4">
      {headerControls && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pb-1">{headerControls}</div>
      )}

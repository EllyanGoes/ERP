...
const tesCusteioFluxo: BpmnGrafo = {
  nodes: [
    ...
    { id: "md", tipo: "tarefa", x: 500,  y: -40, label: "Material direto", sub: "D PEP-MD / C Estoque", cor: "violeta" },
    { id: "ind",tipo: "tarefa", x: 500,  y: 70,  label: "Indireto fabril", sub: "D CIF a Apropriar / C Estoque", cor: "violeta" },
    { id: "moi",tipo: "tarefa", x: 500,  y: 180, label: "MOI — mão de obra indireta (folha)", sub: "D CIF a Apropriar / C Salários", cor: "verde" },
    { id: "mod",tipo: "tarefa", x: 500,  y: 300, label: "MOD — mão de obra direta (folha)", sub: "D PEP-MOD / C Salários", cor: "verde" },
    { id: "ap", tipo: "tarefa", x: 790,  y: 120, label: "Apropriação do CIF", sub: "D PEP-CIF / C CIF a Apropriar", cor: "violeta" },
    { id: "abs",tipo: "tarefa", x: 1020, y: 80,  label: "Absorção", sub: "D Produto Acabado / C PEP (MD+MOD+CIF)", cor: "ambar" },
    { id: "vd", tipo: "tarefa", x: 1260, y: 80,  label: "Venda", sub: "D CPV / C Produto Acabado", cor: "verde" },
    { id: "z",  tipo: "fim",    x: 1480, y: 96,  label: "Custo no resultado (CPV)" },
  ],
  edges: [
    { from: "a", to: "b" }, { from: "b", to: "g" },
    { from: "g", to: "md", label: "direto" }, { from: "g", to: "ind", label: "indireto" },
    { from: "g", to: "moi", label: "MOI" }, { from: "g", to: "mod", label: "MOD" },
    { from: "ind", to: "ap" }, { from: "moi", to: "ap" },
    { from: "md", to: "abs" }, { from: "mod", to: "abs" }, { from: "ap", to: "abs" },
  ...
  },
  {
    ...
    processos: [
      ...
      },
      {
        ...
        texto: "Fechando o ciclo com a contabilidade: a compra entra no Estoque. No uso, o material direto vai para o PEP-MD e o indireto fabril acumula em CIF a Apropriar. A folha divide a mão de obra: MOD (direta) vai para o PEP-MOD e segue direto para a absorção; MOI (indireta) vai para CIF a Apropriar e passa antes pela apropriação do CIF. No fechamento, a apropriação leva o CIF a Apropriar (indiretos + MOI) para o PEP-CIF, e a absorção transfere o PEP (Material + MOD + CIF) para o Produto Acabado. Na venda, o custo sai como CPV no resultado. Assim o produto acabado carrega o custo por absorção (material + mão de obra + indiretos).",
        grafo: tesCusteioFluxo,
        detalhes: [
          "MOD (mão de obra direta) → PEP-MOD (…0002) e entra direto na absorção; MOI (mão de obra indireta) → CIF a Apropriar e passa pela apropriação do CIF antes de absorver.",
          "PEP (Produto em Processo) 1.1.3.0005: subcontas Materiais Aplicados (…0001), MOD (…0002) e CIF (…0003), no Ativo.",
          "CIF a Apropriar 1.1.4.0001: staging do custo indireto real (materiais indiretos + MOI) até a apropriação ao PEP-CIF.",

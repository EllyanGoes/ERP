...
export const ROUTES: RouteEntry[] = [
  ...
  { href: "/marketing/inteligencia-comercial",      label: "Competidores",            group: "Marketing",        section: "Inteligência Comercial", icon: Target,  keywords: "inteligencia comercial ic concorrente concorrentes competidor competidores mercado preço precos fornecedor revendedor" },
  { href: "/marketing/inteligencia-comercial/relatorio-precos", label: "Preço de Mercado", group: "Marketing",   section: "Inteligência Comercial", icon: BarChart3, keywords: "preço médio mercado concorrente competidor competidores relatório comparativo ic inteligencia comercial precos" },
  { href: "/marketing/inteligencia-comercial/mapa", label: "Geomarketing",            group: "Marketing",        section: "Inteligência Comercial", icon: MapIcon, keywords: "geomarketing mapa concorrentes competidor competidores localização leaflet ic inteligencia comercial" },
  ...
  { href: "/contabilidade/cpv",                    label: "CPV",                      group: "Contabilidade",  section: "Processos",    icon: Calculator,     keywords: "cpv custo produtos vendidos contabilidade custeio cif mod taxa indireto biomassa energia combustível folha mão de obra acabado pep absorção" },

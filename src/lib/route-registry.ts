...
export const ROUTES: RouteEntry[] = [
  ...
  { href: "/contabilidade/imobilizado",            label: "Imobilizado",              group: "Contabilidade",  section: "Contabilidade",    icon: Calculator,     keywords: "contabilidade imobilizado ativo não circulante depreciação bem patrimônio vida útil" },
  ...
  { href: "/contabilidade/fechamento",             label: "Encerramento do Exercício", group: "Contabilidade",  section: "Contabilidade",    icon: Calculator,     keywords: "contabilidade fechamento encerramento exercício período resultado lucro prejuízo trava patrimônio líquido" },
  { href: "/contabilidade/razao",                  label: "Razão",                    group: "Contabilidade",  section: "Contabilidade",    icon: Calculator,     keywords: "contabilidade razão livro razao extrato conta auxiliar cliente fornecedor saldo" },
  { href: "/contabilidade/balancete",              label: "Balancete",                group: "Contabilidade",  section: "Contabilidade",    icon: Calculator,     keywords: "contabilidade balancete verificação saldo débito crédito conta" },
  { href: "/contabilidade/dre",                    label: "DRE",                      group: "Contabilidade",  section: "Contabilidade",    icon: Calculator,     keywords: "contabilidade dre demonstração resultado receita custo despesa lucro prejuízo" },
  { href: "/contabilidade/balanco",                label: "Balanço Patrimonial",      group: "Contabilidade",  section: "Contabilidade",    icon: Calculator,     keywords: "contabilidade balanço patrimonial ativo passivo patrimonio liquido posição" },

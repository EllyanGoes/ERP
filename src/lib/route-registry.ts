...
export const ROUTES: RouteEntry[] = [
  ...
  { href: "/contabilidade/plano-contas",           label: "Plano de Contas Contábil", group: "Contabilidade Gerencial",  section: "Contabilidade Gerencial",    icon: Calculator,     keywords: "contabilidade plano contas contábil ativo passivo patrimonio resultado devedora credora razão balancete" },
  { href: "/contabilidade/imobilizado",            label: "Imobilizado",              group: "Contabilidade Gerencial",  section: "Contabilidade Gerencial",    icon: Calculator,     keywords: "contabilidade imobilizado ativo não circulante depreciação bem patrimônio vida útil" },
  { href: "/contabilidade/lancamentos",            label: "Diário Contábil",          group: "Contabilidade Gerencial",  section: "Contabilidade Gerencial",    icon: Calculator,     keywords: "contabilidade diário lançamentos partidas dobradas débito crédito razão" },
  { href: "/contabilidade/fechamento",             label: "Encerramento do Exercício", group: "Contabilidade Gerencial",  section: "Contabilidade Gerencial",    icon: Calculator,     keywords: "contabilidade fechamento encerramento exercício período resultado lucro prejuízo trava patrimônio líquido" },
  { href: "/contabilidade/razao",                  label: "Razão",                    group: "Contabilidade Gerencial",  section: "Contabilidade Gerencial",    icon: Calculator,     keywords: "contabilidade razão livro razao extrato conta auxiliar cliente fornecedor saldo" },
  { href: "/contabilidade/balancete",              label: "Balancete",                group: "Contabilidade Gerencial",  section: "Contabilidade Gerencial",    icon: Calculator,     keywords: "contabilidade balancete verificação saldo débito crédito conta" },
  { href: "/contabilidade/dre",                    label: "DRE",                      group: "Contabilidade Gerencial",  section: "Contabilidade Gerencial",    icon: Calculator,     keywords: "contabilidade dre demonstração resultado receita custo despesa lucro prejuízo" },
  { href: "/contabilidade/balanco",                label: "Balanço Patrimonial",      group: "Contabilidade Gerencial",  section: "Contabilidade Gerencial",    icon: Calculator,     keywords: "contabilidade balanço patrimonial ativo passivo patrimonio liquido posição" },

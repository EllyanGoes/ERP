...
export const ROUTES: RouteEntry[] = [
  ...
  { href: "/pcp/custeio",                          label: "Custeio (CIF/MOD)",       group: "PCP",            section: "Estrutura",        icon: Calculator,     keywords: "pcp custeio cif mod taxa indireto biomassa energia combustível folha mão de obra custo acabado" },

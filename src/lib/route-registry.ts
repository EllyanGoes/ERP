...
export const ROUTES: RouteEntry[] = [
  ...
  { href: "/contabilidade/custeio",                label: "Custeio (CIF/MOD)",        group: "Contabilidade",  section: "Processos",    icon: Calculator,     keywords: "contabilidade custeio cif mod taxa indireto biomassa energia combustível folha mão de obra custo acabado pep absorção" },

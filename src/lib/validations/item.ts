...
export const itemSchema = z.object({
  ...
  categoriaEstoque: z.enum(["PRODUTO_ACABADO", "MERCADORIA", "WIP", "MATERIA_PRIMA", "INSUMO", "COMBUSTIVEL", "EMBALAGEM", "FERRAMENTAS", "RESIDUO_PRODUCAO", "ALMOXARIFADO"]).optional().nullable(),
  ...
  consumivel: z.boolean().default(true),
